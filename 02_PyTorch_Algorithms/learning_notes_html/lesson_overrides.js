  ...
  "05": [
          ...
          <div class="shape-story">
            <div class="story-panel">
              ...
              <div class="mini-table">
                <span>TODO 1</span><strong>搭零件：gate_proj / up_proj / down_proj</strong>
                <span>TODO 2</span><strong>走数据流：SiLU(gate(x)) * up(x) → down</strong>
              </div>
            </div>
            ...
            <div class="story-panel">
              ...
              <div class="mini-table">
                <span>gate_proj</span><strong>hidden_size → intermediate_size</strong>
                <span>up_proj</span><strong>hidden_size → intermediate_size</strong>
                <span>down_proj</span><strong>intermediate_size → hidden_size</strong>
              </div>
              <details class="think">
    ...
    def forward(self, x):
        ...
        <div class="syntax-card">
          ...
          <div class="mini-table">
            <span>switch</span><strong>gate_proj</strong>
            <span>value</span><strong>up_proj</strong>
            <span>out</span><strong>down_proj</strong>
            <span>in_dim</span><strong>hidden_size</strong>
            <span>mid_dim</span><strong>intermediate_size</strong>
          </div>
      ...
      exampleHtml: `
          <div class="shape-story">
            <div class="story-panel">
              ...
              <div class="mini-flow"><span>hidden0</span><span>Attention step</span><span>hidden1</span><span>MLP step</span><strong>hidden2</strong></div>
            </div>
            ...
            <div class="story-panel">
              ...
              <div class="mini-table">
                <span>错误 1</span><strong>第二段还加最初的 x：会跳过 attention 后状态</strong>
                <span>错误 2</span><strong>把 norm 后的张量当 residual：主路不再是原始状态</strong>
                <span>错误 3</span><strong>忘记调用 mlp：mlp 参数拿不到 grad</strong>
              </div>
              <details class="think">
            ...
            <div class="story-panel">
              ...
              <div class="mini-table">
                <span>out.shape 报错</span><strong>检查每段输出是否仍是 [B,S,H]</strong>
                <span>某参数 grad is None</span><strong>检查该子层是否参与了最终输出</strong>
                <span>逻辑顺序混乱</span><strong>按 residual → norm → block → add 重写</strong>
              </div>
            </div>
            <div class="field-note">
...
x = prenorm_step(x, norm_b, mlp_like_block)</code></pre><p class="syntax-tip">读法：不要写成 <code>x = norm(residual + block(x))</code>，那是 Post-Norm 的味道；LLaMA 这里要先 norm，再进子层，最后加 residual。</p></div>
        <div class="syntax-card">
          ...
          <div class="mini-table">
            <span>第 1 遍</span><strong>input_layernorm → self_attn → residual add</strong>
            <span>第 2 遍</span><strong>post_attention_layernorm → mlp → residual add</strong>
            <span>每遍开始</span><strong>先保存当前 hidden_states</strong>
          </div>
