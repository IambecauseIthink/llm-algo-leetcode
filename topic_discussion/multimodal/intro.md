...
![多模态学习路线：从输入对齐到可复核系统](../../docs/public/topic_discussion/multimodal/multimodal_overview.svg)
...
| 需要补的能力 | 入口 | 作用 |
|:---|:---|:---|
| Attention 与 Block | [04 Attention（MHA / GQA）](../../02_PyTorch_Algorithms/04_Attention_MHA_GQA.ipynb)、[05 LLaMA3 Block](../../02_PyTorch_Algorithms/05_LLaMA3_Block_Tutorial.ipynb) | 理解文本 token、视觉 token 与注意力计算的共同形式 |
| 模型架构 | [大模型架构专题](../model_architecture/intro.md) | 补充视觉塔、投影层、融合层和模型变体的结构背景 |
| 训练与微调 | [09 SFT Training Loop](../../02_PyTorch_Algorithms/09_SFT_Training_Loop.ipynb)、[10 LoRA](../../02_PyTorch_Algorithms/10_LoRA_Tutorial.ipynb) | 作为视觉语言模型训练和参数高效微调的共享前置 |
