...
![1A 数值基础与算力估算路线](../docs/public/01_Hardware_Math_and_Systems/1a_numerical_foundations_map.svg)
...
先完成 [01](./01_Data_Types_and_Precision.ipynb) 和 [02](./02_LLM_Params_and_FLOPs.ipynb)，能够从 dtype 和模型配置计算参数存储量、前向 / 训练 FLOPs 以及 MFU；然后按学习目标选择 [21](./21_Quantization_Theory_and_INT4_INT8.ipynb) 或 [22](./22_MoE_Parameter_and_Compute.ipynb)，分别分析量化成本和稀疏专家的参数—计算关系。
