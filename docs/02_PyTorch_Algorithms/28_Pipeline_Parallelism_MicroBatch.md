...
![1F1B：micro-batch 越过 stage 时的时间轴](../public/02_PyTorch_Algorithms/28_pipeline_bubble.svg)
...
- [60. LoRA 微调项目](../02_PyTorch_Algorithms/60_LoRA_Fine_Tuning_Project.md)
