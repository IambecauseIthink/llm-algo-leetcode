...
![通信与并行：从状态切分到多卡收益](../../public/topic_discussion/communication_parallel/communication_parallel_overview.svg)
...
![通信与并行学习路线：从切分目标到多卡决策](../../public/topic_discussion/communication_parallel/communication_parallel_task_route.svg)
