...
- Part 02 [27 ZeRO Optimizer](../../02_PyTorch_Algorithms/27_ZeRO_Optimizer_Sim.md)：观察参数、梯度和 optimizer state 如何分摊；
- Part 02 [28 Pipeline Parallelism](../../02_PyTorch_Algorithms/28_Pipeline_Parallelism_MicroBatch.md)：观察层切分、micro-batch 和流水线气泡；
