...
![分布式显存：从容量缺口到多卡证据](../../public/topic_discussion/memory_performance_tuning/distributed_memory_system_map.svg)
...
- [27 ZeRO 优化器模拟](../../02_PyTorch_Algorithms/27_ZeRO_Optimizer_Sim.md)：观察参数、梯度和 optimizer state 的分摊；
- [28 Pipeline 并行微批次](../../02_PyTorch_Algorithms/28_Pipeline_Parallelism_MicroBatch.md)：观察 stage、micro-batch 和 pipeline bubble；
- [29 Tensor 并行模拟](../../02_PyTorch_Algorithms/29_Tensor_Parallelism_Sim.md)：观察张量切分和通信边界。
...
- [81 分布式推理项目](../../02_PyTorch_Algorithms/81_Distributed_Inference_Project.md)。
