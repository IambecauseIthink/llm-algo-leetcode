...
建议先掌握 [Part 01 · 21 量化理论与 INT4/INT8](../../01_Hardware_Math_and_Systems/21_Quantization_Theory_and_INT4_INT8.md) 的量化理论与 INT4/INT8 基础，再根据目标补读 [Part 02 · 25 W8A16](../../02_PyTorch_Algorithms/25_Quantization_W8A16.md)、[Part 02 · 40 GPTQ/AWQ](../../02_PyTorch_Algorithms/40_GPTQ_and_AWQ_Weight_Quantization.md) 和 [Part 02 · 41 FP8 与 KV Cache 量化](../../02_PyTorch_Algorithms/41_FP8_and_KV_Cache_Quantization.md)。如果重点是训练显存，应同时回看监督微调与显存专题；如果重点是服务吞吐，应先明确推理后端和 workload。
...
| Task2 | PTQ / QAT 的介入时机 | [Part 01 · 21 量化理论与 INT4/INT8](../../01_Hardware_Math_and_Systems/21_Quantization_Theory_and_INT4_INT8.md) → [Part 02 · 25 W8A16](../../02_PyTorch_Algorithms/25_Quantization_W8A16.md) → [Part 02 · 26 QLoRA 与 4bit 量化](../../02_PyTorch_Algorithms/26_QLoRA_and_4bit_Quantization.md) | [02 PTQ 与 QAT 的时机](./02_ptq_and_qat_timing.md) |
...
| Task4 | GPTQ / AWQ 的后训练压缩 | [Part 02 · 25 W8A16](../../02_PyTorch_Algorithms/25_Quantization_W8A16.md) → [Part 02 · 40 GPTQ / AWQ](../../02_PyTorch_Algorithms/40_GPTQ_and_AWQ_Weight_Quantization.md) | [04 权重压缩](./04_weight_only_compression.md) |
...
| Task6 | 量化部署、benchmark 与项目收口 | [Part 02 · 65 QLoRA 选型](../../02_PyTorch_Algorithms/65_QLoRA_Selection_Project.md) → [Part 02 · 66 推理性能比较](../../02_PyTorch_Algorithms/66_Inference_Performance_Comparison.md) → [Part 02 · 67 量化推理与部署](../../02_PyTorch_Algorithms/67_Quantized_Inference_and_Deployment.md) | [06 部署与基准测试决策](./06_deployment_and_benchmark_decision.md) |
